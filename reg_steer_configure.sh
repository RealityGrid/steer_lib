...
export REG_STEER_HOME=$HOME/projects/reg_steer_lib

# Set directory location to use for steering communication
export REG_STEER_DIRECTORY=/scratch/zzcguap/steering
...
export REG_XML_LIBDIR=/usr/freeware/lib
...
export GLOBUS_TCP_PORT_RANGE=2566,2566
...
export REG_SGS_ADDRESS=http://vermont.mvc.mcc.ac.uk:50005/
