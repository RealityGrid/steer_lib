...
setenv REG_XML_LIBDIR $HOME/libxml2-2.4.24/lib
setenv REG_XML_INCDIR $HOME/libxml2-2.4.24/include

setenv LD_LIBRARY_PATH ${LD_LIBRARY_PATH}:$HOME/libxml2-2.4.24/lib32

setenv REG_CONNECTOR_HOSTNAME  bert.mvc.mcc.ac.uk
