...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.2.3b 2003-10-09 15:12:30 GMT")
...
SOAP_FMAC1 int SOAP_FMAC2 soap_getindependent(struct soap *soap)
{
	...
	{	if (soap_peek_element(soap))
		...
		case SOAP_TYPE_tns__setServiceData:
			...
			break;
		case SOAP_TYPE_tns__AppRecordChkpoint:
			soap_in_tns__AppRecordChkpoint(soap, NULL, NULL, "tns:AppRecordChkpoint");
			break;
		...
		case SOAP_TYPE_tns__GetControlResponse:
			...
			break;
		case SOAP_TYPE_tns__AppRecordChkpointResponse:
			soap_in_tns__AppRecordChkpointResponse(soap, NULL, NULL, "tns:AppRecordChkpointResponse");
			break;
		...
		case SOAP_TYPE_PointerTotns__setServiceDataResponse:
			...
			break;
		case SOAP_TYPE_PointerTotns__AppRecordChkpointResponse:
			soap_in_PointerTotns__AppRecordChkpointResponse(soap, NULL, NULL, "tns:AppRecordChkpointResponse");
			break;
		...
		case SOAP_TYPE_xsdl__setServiceDataResponse:
			...
			break;
		case SOAP_TYPE_xsdl__AppRecordChkpointResponse:
			soap_in_xsdl__AppRecordChkpointResponse(soap, NULL, NULL, "xsdl:AppRecordChkpointResponse");
			break;
		...
		for (pp = soap->pht[i]; pp; pp = pp->next)
			if ((soap->mode & SOAP_IO_LENGTH) ? pp->mark1 == 2 : pp->mark2 == 2)
				...
				case SOAP_TYPE_tns__setServiceData:
					...
					break;
				case SOAP_TYPE_tns__AppRecordChkpoint:
					soap_out_tns__AppRecordChkpoint(soap, "id", pp->id, (const struct tns__AppRecordChkpoint *)pp->ptr, "tns:AppRecordChkpoint");
					break;
				case SOAP_TYPE_tns__findServiceData:
				...
				case SOAP_TYPE_tns__GetControlResponse:
					...
					break;
				case SOAP_TYPE_tns__AppRecordChkpointResponse:
					soap_out_tns__AppRecordChkpointResponse(soap, "id", pp->id, (const struct tns__AppRecordChkpointResponse *)pp->ptr, "tns:AppRecordChkpointResponse");
					break;
				case SOAP_TYPE_tns__GetNotificationsResponse:
				...
				case SOAP_TYPE_PointerTotns__setServiceDataResponse:
					...
					break;
				case SOAP_TYPE_PointerTotns__AppRecordChkpointResponse:
					soap_out_PointerTotns__AppRecordChkpointResponse(soap, "id", pp->id, (struct tns__AppRecordChkpointResponse *const*)pp->ptr, "tns:AppRecordChkpointResponse");
					break;
				case SOAP_TYPE_PointerTotns__findServiceDataResponse:
				...
				case SOAP_TYPE_xsdl__setServiceDataResponse:
					...
					break;
				case SOAP_TYPE_xsdl__AppRecordChkpointResponse:
					soap_out_string(soap, "id", pp->id, (char**)&pp->ptr, "xsdl:AppRecordChkpointResponse");
					break;
				case SOAP_TYPE_xsdl__destroyRequest:
...
SOAP_FMAC1 int SOAP_FMAC2 soap_getattachments(struct soap *soap)
{
	...
	{	if (soap_getdime(soap) || !soap->dime_id)
		...
		case SOAP_TYPE_xsdl__AppRecordChkpointRequest:
		{	char ** a;
			a = (char **)soap_id_enter(soap, soap->dime_id, NULL, SOAP_TYPE_xsdl__AppRecordChkpointRequest, sizeof(char *), 0);
			if (a)
				*a = soap->dime_ptr;
			break;
		}
		...
		case SOAP_TYPE_xsdl__AppRecordChkpointResponse:
		{	char ** a;
			a = (char **)soap_id_enter(soap, soap->dime_id, NULL, SOAP_TYPE_xsdl__AppRecordChkpointResponse, sizeof(char *), 0);
			if (a)
				*a = soap->dime_ptr;
			break;
		}
...
SOAP_FMAC1 void SOAP_FMAC2 soap_serialize_tns__AppRecordChkpoint(struct soap *soap, struct tns__AppRecordChkpoint const*a)
{
	if (!soap_reference(soap, a, SOAP_TYPE_tns__AppRecordChkpoint))
		soap_mark_tns__AppRecordChkpoint(soap, a);
}

SOAP_FMAC1 void SOAP_FMAC2 soap_mark_tns__AppRecordChkpoint(struct soap *soap, const struct tns__AppRecordChkpoint *a)
{
	soap_embedded(soap, &a->chk_USCORE_meta_USCORE_data, SOAP_TYPE_xsd__string);
	soap_mark_xsd__string(soap, &a->chk_USCORE_meta_USCORE_data);
	soap_embedded(soap, &a->node_USCORE_meta_USCORE_data, SOAP_TYPE_xsd__string);
	soap_mark_xsd__string(soap, &a->node_USCORE_meta_USCORE_data);
}

SOAP_FMAC1 void SOAP_FMAC2 soap_default_tns__AppRecordChkpoint(struct soap *soap, struct tns__AppRecordChkpoint *a)
{
	soap_default_xsd__string(soap, &a->chk_USCORE_meta_USCORE_data);
	soap_default_xsd__string(soap, &a->node_USCORE_meta_USCORE_data);
}

SOAP_FMAC1 int SOAP_FMAC2 soap_put_tns__AppRecordChkpoint(struct soap *soap, struct tns__AppRecordChkpoint *a, const char *tag, const char *type)
{
	int i;
	struct soap_plist *pp;
	if ((i = soap_pointer_lookup(soap, a, SOAP_TYPE_tns__AppRecordChkpoint, &pp)))
		if (soap_is_embedded(soap, pp))
			soap_element_ref(soap, tag, 0, i);
		else if (soap_is_single(soap, pp))
			soap_out_tns__AppRecordChkpoint(soap, tag, 0, a, type);
		else
		{
			soap_set_embedded(soap, pp);
			soap_out_tns__AppRecordChkpoint(soap, tag, i, a, type);
		}
	else
		soap_out_tns__AppRecordChkpoint(soap, tag, 0, a, type);
	return soap_putindependent(soap);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_out_tns__AppRecordChkpoint(struct soap *soap, const char *tag, int id, const struct tns__AppRecordChkpoint *a, const char *type)
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_tns__AppRecordChkpoint), type);
	soap_out_xsd__string(soap, "chk_meta_data", -1, &a->chk_USCORE_meta_USCORE_data, "xsd:string");
	soap_out_xsd__string(soap, "node_meta_data", -1, &a->node_USCORE_meta_USCORE_data, "xsd:string");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
}

SOAP_FMAC1 struct tns__AppRecordChkpoint * SOAP_FMAC2 soap_get_tns__AppRecordChkpoint(struct soap *soap, struct tns__AppRecordChkpoint *p, const char *tag, const char *type)
{
	if ((p = soap_in_tns__AppRecordChkpoint(soap, tag, p, type)))
		soap_getindependent(soap);
	return p;
}

SOAP_FMAC1 struct tns__AppRecordChkpoint * SOAP_FMAC2 soap_in_tns__AppRecordChkpoint(struct soap *soap, const char *tag, struct tns__AppRecordChkpoint *a, const char *type)
{
	short soap_flag_chk_USCORE_meta_USCORE_data = 1, soap_flag_node_USCORE_meta_USCORE_data = 1;
	if (soap_element_begin_in(soap, tag))
		return NULL;
	if (*soap->type && soap_match_tag(soap, soap->type, type))
	{	soap->error = SOAP_TYPE_MISMATCH;
	...
	if (!*soap->href)
	{	a = (struct tns__AppRecordChkpoint *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_tns__AppRecordChkpoint, sizeof(struct tns__AppRecordChkpoint), 0);
		if (!a)
			return NULL;
		if (soap->alloced)
			soap_default_tns__AppRecordChkpoint(soap, a);
		if (soap->body)
		{	for (;;)
			{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_chk_USCORE_meta_USCORE_data && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_xsd__string(soap, "chk_meta_data", &a->chk_USCORE_meta_USCORE_data, "xsd:string"))
				{	soap_flag_chk_USCORE_meta_USCORE_data = 0;
					continue;
				}
			if (soap_flag_node_USCORE_meta_USCORE_data && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_xsd__string(soap, "node_meta_data", &a->node_USCORE_meta_USCORE_data, "xsd:string"))
				{	soap_flag_node_USCORE_meta_USCORE_data = 0;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
				soap->error = soap_ignore_element(soap);
	...
	{	a = (struct tns__AppRecordChkpoint *)soap_id_forward(soap, soap->href, (void**)soap_id_enter(soap, soap->id, a, SOAP_TYPE_tns__AppRecordChkpoint, sizeof(struct tns__AppRecordChkpoint), 0), SOAP_TYPE_tns__AppRecordChkpoint, sizeof(struct tns__AppRecordChkpoint));
		if (soap->alloced)
			soap_default_tns__AppRecordChkpoint(soap, a);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
...
SOAP_FMAC1 void SOAP_FMAC2 soap_serialize_tns__AppRecordChkpointResponse(struct soap *soap, struct tns__AppRecordChkpointResponse const*a)
{
	if (!soap_reference(soap, a, SOAP_TYPE_tns__AppRecordChkpointResponse))
		soap_mark_tns__AppRecordChkpointResponse(soap, a);
}

SOAP_FMAC1 void SOAP_FMAC2 soap_mark_tns__AppRecordChkpointResponse(struct soap *soap, const struct tns__AppRecordChkpointResponse *a)
{
	soap_embedded(soap, &a->_result, SOAP_TYPE_xsd__string);
	soap_mark_xsd__string(soap, &a->_result);
}

SOAP_FMAC1 void SOAP_FMAC2 soap_default_tns__AppRecordChkpointResponse(struct soap *soap, struct tns__AppRecordChkpointResponse *a)
{
	soap_default_xsd__string(soap, &a->_result);
}

SOAP_FMAC1 int SOAP_FMAC2 soap_put_tns__AppRecordChkpointResponse(struct soap *soap, struct tns__AppRecordChkpointResponse *a, const char *tag, const char *type)
{
	int i;
	struct soap_plist *pp;
	if ((i = soap_pointer_lookup(soap, a, SOAP_TYPE_tns__AppRecordChkpointResponse, &pp)))
		if (soap_is_embedded(soap, pp))
			soap_element_ref(soap, tag, 0, i);
		else if (soap_is_single(soap, pp))
			soap_out_tns__AppRecordChkpointResponse(soap, tag, 0, a, type);
		else
		{
			soap_set_embedded(soap, pp);
			soap_out_tns__AppRecordChkpointResponse(soap, tag, i, a, type);
		}
	else
		soap_out_tns__AppRecordChkpointResponse(soap, tag, 0, a, type);
	return soap_putindependent(soap);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_out_tns__AppRecordChkpointResponse(struct soap *soap, const char *tag, int id, const struct tns__AppRecordChkpointResponse *a, const char *type)
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_tns__AppRecordChkpointResponse), type);
	soap_out_xsd__string(soap, "result", -1, &a->_result, "xsd:string");
	soap_element_end_out(soap, tag);
	return SOAP_OK;
}

SOAP_FMAC1 struct tns__AppRecordChkpointResponse * SOAP_FMAC2 soap_get_tns__AppRecordChkpointResponse(struct soap *soap, struct tns__AppRecordChkpointResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_tns__AppRecordChkpointResponse(soap, tag, p, type)))
		soap_getindependent(soap);
	return p;
}

SOAP_FMAC1 struct tns__AppRecordChkpointResponse * SOAP_FMAC2 soap_in_tns__AppRecordChkpointResponse(struct soap *soap, const char *tag, struct tns__AppRecordChkpointResponse *a, const char *type)
{
	short soap_flag__result = 1;
	if (soap_element_begin_in(soap, tag))
		return NULL;
	...
	if (!*soap->href)
	{	a = (struct tns__AppRecordChkpointResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_tns__AppRecordChkpointResponse, sizeof(struct tns__AppRecordChkpointResponse), 0);
		if (!a)
			return NULL;
		if (soap->alloced)
			soap_default_tns__AppRecordChkpointResponse(soap, a);
		if (soap->body)
		{	for (;;)
			{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag__result && soap->error == SOAP_TAG_MISMATCH)
	...
	{	a = (struct tns__AppRecordChkpointResponse *)soap_id_forward(soap, soap->href, (void**)soap_id_enter(soap, soap->id, a, SOAP_TYPE_tns__AppRecordChkpointResponse, sizeof(struct tns__AppRecordChkpointResponse), 0), SOAP_TYPE_tns__AppRecordChkpointResponse, sizeof(struct tns__AppRecordChkpointResponse));
		if (soap->alloced)
			soap_default_tns__AppRecordChkpointResponse(soap, a);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
...
SOAP_FMAC1 void SOAP_FMAC2 soap_serialize_PointerTotns__AppRecordChkpointResponse(struct soap *soap, struct tns__AppRecordChkpointResponse *const*a)
{
	if (!soap_reference(soap, a, SOAP_TYPE_PointerTotns__AppRecordChkpointResponse))
		soap_mark_PointerTotns__AppRecordChkpointResponse(soap, a);
}

SOAP_FMAC1 void SOAP_FMAC2 soap_mark_PointerTotns__AppRecordChkpointResponse(struct soap *soap, struct tns__AppRecordChkpointResponse *const*a)
{
	if (!soap_reference(soap, *a, SOAP_TYPE_tns__AppRecordChkpointResponse))
		soap_mark_tns__AppRecordChkpointResponse(soap, *a);
}

SOAP_FMAC1 void SOAP_FMAC2 soap_default_PointerTotns__AppRecordChkpointResponse(struct soap *soap, struct tns__AppRecordChkpointResponse **a)
{
	*a = NULL;
}

SOAP_FMAC1 int SOAP_FMAC2 soap_put_PointerTotns__AppRecordChkpointResponse(struct soap *soap, struct tns__AppRecordChkpointResponse **a, const char *tag, const char *type)
{
	int i;
	struct soap_plist *pp;
	if ((i = soap_pointer_lookup(soap, a, SOAP_TYPE_PointerTotns__AppRecordChkpointResponse, &pp)))
		if (soap_is_embedded(soap, pp))
			soap_element_ref(soap, tag, 0, i);
		else if (soap_is_single(soap, pp))
			soap_out_PointerTotns__AppRecordChkpointResponse(soap, tag, 0, a, type);
		else
		{
			soap_set_embedded(soap, pp);
			soap_out_PointerTotns__AppRecordChkpointResponse(soap, tag, i, a, type);
		}
	else
		soap_out_PointerTotns__AppRecordChkpointResponse(soap, tag, 0, a, type);
	return soap_putindependent(soap);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_out_PointerTotns__AppRecordChkpointResponse(struct soap *soap, const char *tag, int id, struct tns__AppRecordChkpointResponse *const*a, const char *type)
{
	id = soap_embedded_id(soap, id, a, SOAP_TYPE_PointerTotns__AppRecordChkpointResponse);
	if (!*a)
		soap_element_null(soap, tag, id, type);
	else
	{	struct soap_plist *pp;
		int i = soap_pointer_lookup(soap, *a, SOAP_TYPE_tns__AppRecordChkpointResponse, &pp);
		if (i)
			if (soap_is_embedded(soap, pp))
				soap_element_ref(soap, tag, id, i);
			else if (soap_is_single(soap, pp))
			...
			soap_out_tns__AppRecordChkpointResponse(soap, tag, soap_pointer_enter(soap, *a, SOAP_TYPE_tns__AppRecordChkpointResponse, &pp), *a, type);
	}
	return SOAP_OK;
}

SOAP_FMAC1 struct tns__AppRecordChkpointResponse ** SOAP_FMAC2 soap_get_PointerTotns__AppRecordChkpointResponse(struct soap *soap, struct tns__AppRecordChkpointResponse **p, const char *tag, const char *type)
{
	if ((p = soap_in_PointerTotns__AppRecordChkpointResponse(soap, tag, p, type)))
		soap_getindependent(soap);
	return p;
}

SOAP_FMAC1 struct tns__AppRecordChkpointResponse ** SOAP_FMAC2 soap_in_PointerTotns__AppRecordChkpointResponse(struct soap *soap, const char *tag, struct tns__AppRecordChkpointResponse **a, const char *type)
{
	struct tns__AppRecordChkpointResponse *p;
	if (soap_element_begin_in(soap, tag))
		return NULL;
	if (soap->null)
	{	a = (struct tns__AppRecordChkpointResponse **)soap_id_enter(soap, soap->id, a, SOAP_TYPE_PointerTotns__AppRecordChkpointResponse, sizeof(struct tns__AppRecordChkpointResponse *), 1);
		if (a)
			*a = NULL;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	...
	{	soap_revert(soap);
		if (a)
		{	if ((p = soap_in_tns__AppRecordChkpointResponse(soap, tag, *a, type)))
				*a = p;
			else
				a = NULL;
		}
		else if ((p = soap_in_tns__AppRecordChkpointResponse(soap, tag, NULL, type)))
		{	a = (struct tns__AppRecordChkpointResponse **)soap_id_enter(soap, "", NULL, SOAP_TYPE_PointerTotns__AppRecordChkpointResponse, sizeof(struct tns__AppRecordChkpointResponse *), 0);
			if (a)
				*a = p;
		}
	}
	else
	{	a = (struct tns__AppRecordChkpointResponse **)soap_id_lookup(soap, soap->href, (void**)soap_id_enter(soap, soap->id, a, SOAP_TYPE_PointerTotns__AppRecordChkpointResponse, sizeof(struct tns__AppRecordChkpointResponse *), 1), SOAP_TYPE_tns__AppRecordChkpointResponse, sizeof(struct tns__AppRecordChkpointResponse), 0);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 void SOAP_FMAC2 soap_default_xsdl__AppRecordChkpointRequest(struct soap *soap, char **a)
{
#ifdef SOAP_DEFAULT_xsdl__AppRecordChkpointRequest
	*a = SOAP_DEFAULT_xsdl__AppRecordChkpointRequest;
#else
	*a = (char *)0;
#endif
}

SOAP_FMAC1 void SOAP_FMAC2 soap_serialize_xsdl__AppRecordChkpointRequest(struct soap *soap, char *const*a)
{
	soap_reference(soap, *a, SOAP_TYPE_xsdl__AppRecordChkpointRequest);
}

SOAP_FMAC1 void SOAP_FMAC2 soap_mark_xsdl__AppRecordChkpointRequest(struct soap *soap, char *const*a)
{
	soap_reference(soap, *a, SOAP_TYPE_xsdl__AppRecordChkpointRequest);
}

SOAP_FMAC1 int SOAP_FMAC2 soap_put_xsdl__AppRecordChkpointRequest(struct soap *soap, char **a, const char *tag, const char *type)
{
	int i;
	struct soap_plist *pp;
	if ((i = soap_pointer_lookup(soap, a, SOAP_TYPE_xsdl__AppRecordChkpointRequest, &pp)))
		if (soap_is_embedded(soap, pp))
			soap_element_ref(soap, tag, 0, i);
		else if (soap_is_single(soap, pp))
			soap_out_xsdl__AppRecordChkpointRequest(soap, tag, 0, a, type);
		else
		{
			soap_set_embedded(soap, pp);
			soap_out_xsdl__AppRecordChkpointRequest(soap, tag, i, a, type);
		}
	else
		soap_out_xsdl__AppRecordChkpointRequest(soap, tag, 0, a, type);
	return soap_putindependent(soap);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_out_xsdl__AppRecordChkpointRequest(struct soap *soap, const char *tag, int id, char *const*a, const char *type)
{
	return soap_outstring(soap, tag, id, a, type, SOAP_TYPE_xsdl__AppRecordChkpointRequest);
}

SOAP_FMAC1 char ** SOAP_FMAC2 soap_get_xsdl__AppRecordChkpointRequest(struct soap *soap, char **p, const char *tag, const char *type)
{
	if ((p = soap_in_xsdl__AppRecordChkpointRequest(soap, tag, p, type)))
		soap_getindependent(soap);
	return p;
}

SOAP_FMAC1 char * * SOAP_FMAC2 soap_in_xsdl__AppRecordChkpointRequest(struct soap *soap, const char *tag, char **a, const char *type)
{
...
SOAP_FMAC1 void SOAP_FMAC2 soap_default_xsdl__AppRecordChkpointResponse(struct soap *soap, char **a)
{
#ifdef SOAP_DEFAULT_xsdl__AppRecordChkpointResponse
	*a = SOAP_DEFAULT_xsdl__AppRecordChkpointResponse;
#else
	*a = (char *)0;
#endif
}

SOAP_FMAC1 void SOAP_FMAC2 soap_serialize_xsdl__AppRecordChkpointResponse(struct soap *soap, char *const*a)
{
	soap_reference(soap, *a, SOAP_TYPE_xsdl__AppRecordChkpointResponse);
}

SOAP_FMAC1 void SOAP_FMAC2 soap_mark_xsdl__AppRecordChkpointResponse(struct soap *soap, char *const*a)
{
	soap_reference(soap, *a, SOAP_TYPE_xsdl__AppRecordChkpointResponse);
}

SOAP_FMAC1 int SOAP_FMAC2 soap_put_xsdl__AppRecordChkpointResponse(struct soap *soap, char **a, const char *tag, const char *type)
{
	int i;
	struct soap_plist *pp;
	if ((i = soap_pointer_lookup(soap, a, SOAP_TYPE_xsdl__AppRecordChkpointResponse, &pp)))
		if (soap_is_embedded(soap, pp))
			soap_element_ref(soap, tag, 0, i);
		else if (soap_is_single(soap, pp))
			soap_out_xsdl__AppRecordChkpointResponse(soap, tag, 0, a, type);
		else
		{
			soap_set_embedded(soap, pp);
			soap_out_xsdl__AppRecordChkpointResponse(soap, tag, i, a, type);
		}
	else
		soap_out_xsdl__AppRecordChkpointResponse(soap, tag, 0, a, type);
	return soap_putindependent(soap);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_out_xsdl__AppRecordChkpointResponse(struct soap *soap, const char *tag, int id, char *const*a, const char *type)
{
	return soap_outstring(soap, tag, id, a, type, SOAP_TYPE_xsdl__AppRecordChkpointResponse);
}

SOAP_FMAC1 char ** SOAP_FMAC2 soap_get_xsdl__AppRecordChkpointResponse(struct soap *soap, char **p, const char *tag, const char *type)
{
	if ((p = soap_in_xsdl__AppRecordChkpointResponse(soap, tag, p, type)))
		soap_getindependent(soap);
	return p;
}

SOAP_FMAC1 char * * SOAP_FMAC2 soap_in_xsdl__AppRecordChkpointResponse(struct soap *soap, const char *tag, char **a, const char *type)
{
	return soap_instring(soap, tag, a, type, SOAP_TYPE_xsdl__AppRecordChkpointResponse, 1);
}
